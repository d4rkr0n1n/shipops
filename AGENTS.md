...
- The site presents service capabilities, scope boundaries, process details, pricing, FAQs, and a contact call to action.
...
- Keep weekly billing labels and the one-time Lite Audit distinction consistent in the cards, contact dialog, README, and any future checkout flow.
...
- Do not describe plan selection as a completed purchase. Payment providers, checkout verification, and client intake automation are planned rather than implemented.
